...
onMounted(async () => {
    try {
        await usePenugasan.getPenugasanAll();
        penugasans.value = usePenugasan.dataPenugasan.data
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Riawayat Penugasan</h4>
                                        </div>
                                        <div>
                                            <router-link class="btn btn-primary  text-white mb-0 me-0"
                                                :to="{ name: 'Department.Create' }"><i class="mdi mdi-account-plus"></i>
                                                Tambah Penugasan</router-link>
                                        </div>
                                    </div>
                                    <div v-if="usePenugasan.isLoading.halaman"
